...
paymentForm.addEventListener( 'submit', function(e){
    ...
    const name = paymentFormData.get('cardName')
    console.log(name)
    document.getElementById(`payment-container`).style.display = 'none'
    document.getElementById(`order-container`).style.display = 'none'
    appreciationContainer.style.display = 'inline'
    
    appreciationContainer.innerHTML=`<div class="appreciation">
                                    <span class="appreciation-text">Thanks, ${name}! Your order is on its way!</span>
                                </div>`
...
render()import { menuArray } from './data.js'
